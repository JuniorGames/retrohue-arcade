      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex items-start gap-2 justify-center text-center py-4 px-3 rounded-md border border-neon-yellow/30 bg-neon-yellow/5">
          ...
          <p className="text-xs text-neon-yellow">
            Os jogos e plataformas contidos nesta página podem ficar fora do ar sem aviso, trata-se de conteúdos públicos na internet, não contém servidor particular de armazenamento de roms e emuladores, tudo está nos seus respectivos serviços e servidores!
          </p>
        </div>
      </div>
